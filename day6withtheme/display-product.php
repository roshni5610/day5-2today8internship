...
<body class="cbp-spmenu-push">
	...
	?> 
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h2 class="title1">productTables</h2>
					<div class="panel-body widget-shadow">
						...
						<table class="table">
							...
							<?php
							 ...
							 {
								 $did=$_GET['did'];
								$deleteq= mysqli_query($connection,"delete from product where pro_id='{$did}'") or die (mysqli_error($connection));
								if($deleteq)
								{
							...
							$selectq=mysqli_query($connection,"select *from product") or die(mysqli_error($connection));
