<?php
	 ...
	 if(!isset($_GET['edit'])|| empty($_GET['eid']))
	 {
		 
		 header("location:display-product.php");
	 }
	 
	 $selectq=mysqli_query($connection, "select *from product where pro_id='{$editid}'") or die(mysqli_error($connection));
					...
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						<div class="form-title">
							...
							<div class="form-body">
								...
								<div class="col-sm-9">
								<input type="text" class="form-control" id="inputEmail3"  value="<?php echo $selectrow['pro_name'] ?>"name="pname" placeholder="enter product name" required> </div> </div> 
								<div class="form-group"> 
								<label for="inputEmail3" class="col-sm-2 control-label">product price</label>
								<div class="col-sm-9">
								<input type="text" class="form-control" id="inputEmail3"  value="<?php echo $selectrow['pro_price'] ?>"name="pprice" placeholder="enter product price" required> </div> </div> 
								<div class="form-group"> 
